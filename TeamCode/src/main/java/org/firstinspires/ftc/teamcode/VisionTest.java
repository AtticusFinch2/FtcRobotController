...
public class VisionTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()) {
            ...
            if(TeamMarkerDetection.truePath == 1){
                Path1();
                telemetry.addData("P1: ", teamMarkerDetection.getPosition());
                telemetry.update();
                break;
            }else if(TeamMarkerDetection.truePath == 2){
                Path2();
                telemetry.addData("P2: ", teamMarkerDetection.getPosition());
                telemetry.update();
                break;
            }else if(TeamMarkerDetection.truePath == 3){
                Path3();
                telemetry.addData("P3: ", teamMarkerDetection.getPosition());
                telemetry.update();
                break;
            }
